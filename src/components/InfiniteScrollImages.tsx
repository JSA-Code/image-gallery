...
export default function InfiniteScrollImages({ initialPhotos, term }: Props) {
  ...
  const loadMorePhotos = useCallback(async () => {
    ...
    const url =
      term === "curated"
        ? `https://api.pexels.com/v1/curated?page=${next}`
        : `https://api.pexels.com/v1/search?query=${term}&page=${next}`;
